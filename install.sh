...
cd /home/ryan/; rm .emacs; rm -rf .emacs.d; mkdir $EMACS_ROOT; git clone $EMACSD_GIT $EMACS_ROOT;  git clone $XREF_JS2_GIT $EMACS_SITE_LISP/xref-js2; emacsclient -e "(kill-emacs)"; emacs --daemon;
